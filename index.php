...
<!-- Title -->
<title>Jason - Sr. Full Stack Engineer &amp; Architect</title>
    	...
    	<div id="skill">
          ...
          <div id="blog">
                ...
                <div class="logo">
                  ...
                  <li data-tooltip="skill" data-position="top">
                    <!--<a href="#skill" class="icon-r fas fa-address-book"></a>-->
                    <a href="#skill" class="icon-r fab fa-superpowers"></a>
                  </li>
              ...
              <div class="page pt-about" data-simplebar>
                  ...
                  <div class="header-page mt-70 mob-mt">
                    ...
                    <span></span>
                          ...
                          <!-- Icon Info -->
					        ...
					        <!-- Interests Row Start -->
					        <div class="row mt-100" style="display: none;">
                    ...
                    <div class="col-lg-6 col-sm-6">
                      <div class="service box-2 mb-40">
                        ...
                        <p>Platforms, SaaS App, SPA, PWA, Real-time Dashboards and Browser Extensions.</p>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                      <div class="service box-2 mb-40">
                        ...
                        <h4>Responsive</h4>
                        <p>Pixel-perfect Layout and Cross-browser / Cross-device Compatibility.</p>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                      <div class="service box-2 mb-40">
                        ...
                        <p>Hybrid / Native Mobile Applications. Simplicity, Speed, Flexibility, Security and Good Image Resolution.</p>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                      <div class="service box-1 mb-40">
                        ...
                        <h4>API</h4>
                        <p>Custom API Development, SOAP, Third-party API Integration, Writing Documentation.</p>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                      <div class="service box-1 mb-40">
                        ...
                        <h4>E-commerce</h4>
                        <p>Store Creation, Campaigns, Email Newsletter, Maintenance and Ongoing Development</p>
                      </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="testimonial-item">
                        ...
                        <div class="comment pt-30">
                          <p>
                            ...
                            He had provided great solutions to some challenging problems and that worked nicely. 
                            He was so reasonable when it came to unexpected situation in work.
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="testimonial-item">
                        ...
                        <div class="comment pt-30">
                          <p>
                            Knowledgeable and workws with diligence. 
                            Jason is a great asset for new technologies. 
                            Our Angular 6 application required a high degree of technical capability and Jason exceeded 
                            our expectation with a fast turn around time.
                          </p>
                        </div>
                      </div>
                        ...
                        <div class="comment pt-30">
                          <p>
                            Jason was able to figure out and fix our API bugs where other programmers were unable to 
                            solve the problem. We will be using him going forward for our API work.
                          </p>
                        </div>
                      </div>
                      ...
                      <!-- Testimonail Item -->
                        ...
                        <div class="comment pt-30">
                          <p>
                            He is a very capable developer that understands and finishes every task 
                            he is given and does a quality job. Great communication and easy to work with.
                          </p>
                        </div>
                      </div>
                      ...
                      <!-- Testimonail Item -->
                        ...
                        <div class="media">
                          <!--<img src="img/testimonials/testimonial-3.jpg" alt="">!-->
                          <div class="content">
                            <h4>Kimberly Paternoster</h4>
                            <p>Design into Layouts</p>
                          </div>
                          <ul class="rating">
                            <li><i class="far fa-star"></i></li>
                            <li><i class="far fa-star"></i></li>
                        ...
                        <div class="comment pt-30">
                          <p>
                            Jason is one of the best developers I've met with from Upwork. 
                            He initially took on another job for me doing Meteor development, and he is AMAZING at that. 
                            Then, I found out he is a great HTML/CSS responsive buildout guy, so I invited him to do this job for me too. 
                            His attention to detail is great, and I appreciate his communication style. 
                            Thank you Jason for all your help with this project.
                          </p>
                        </div>
                      </div>
                  ...
                  <div class="row mt-100 mb-60"></div>
                  
					        <!-- Price Row Start -->  
					        <div class="row mt-100 mb-60" style="display: none;">
			        ...
			        <!-- Resume Section -->
          	  <div class="page pt-skill" data-simplebar>
            	  <section class="container">
